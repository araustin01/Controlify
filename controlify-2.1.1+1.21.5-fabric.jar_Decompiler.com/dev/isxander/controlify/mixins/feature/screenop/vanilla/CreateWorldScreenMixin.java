...
public abstract class CreateWorldScreenMixin implements ScreenProcessorProvider {
   @Unique
   private final ScreenProcessor<class_525> processor = new CreateWorldScreenProcessor((class_525)this, this::method_2736);
   ...
   from = @At(
   value = "FIELD",
   target = "Lnet/minecraft/class_5244;field_24335:Lnet/minecraft/class_2561;"
)
)},
      at = {@At(
   value = "INVOKE",
